# Copy-paste from https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py

# Modifications to the original implementation

# 1) Eliminate the chance of loading pretrained models from URL
# 2) Eliminate faltten and fc as well as num_classes from ResNet class
# 3) Adapt conv1 in ResNet class to receive 3*crop_measures number of channels
